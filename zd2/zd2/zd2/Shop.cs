...
namespace zd2
{
    class Shop
    {
        ...
        public void SellProducts(string[] productNames) // продажа нескольких продуктов по имени
        { 
        ...
        public void SellProducts(int count, string name) // продажа нескольких продуктов по количеству
        {
        ...
        public decimal Check() // получение чека покупки
        {
            return check;
        }
        public void NewSell() // новая покупка
        {
            check = 0;
        }
    }
